namespace Loupedeck.UnofficialVoicemodPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.UnofficialVoicemodPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.UnofficialVoicemodPlugin.Resources.Resource.txt`.
